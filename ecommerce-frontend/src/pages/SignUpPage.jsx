    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white rounded-r-2xl p-8">
        <div className="max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold mb-1">Welcome to Shirt CO</h2>
          ...
          <form className="mt-6 space-y-4">
            ...
            <button className="w-full flex items-center justify-center bg-black text-white py-2 rounded-md">
              <img
